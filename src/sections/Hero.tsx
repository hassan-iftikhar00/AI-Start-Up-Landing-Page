...
export const Hero = () => {
  ...
  return (
    <motion.section
      ...
      // the styling gives the face at top and bottom of the page + more
      className="h-[30.75rem] md:h-[800px] flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]"
      style={{
        backgroundImage: `url(${starsBg.src})`,
        backgroundPositionY,
      }}
    >
      {/* TAILWIND FOR PLANET BACKGROUND LIGHT */}
      <div className="absolute inset-0 bg-[radial-gradient(75%_75%_at_center_center,rgb(140,69,255,.5)_15%,rgb(14,0,36,.5)_78%,transparent)]"></div>
      {/* TAILWIND FOR PLANET */}
      <div className="absolute h-64 w-64 md:h-96 md:w-96 bg-purple-500 rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(50%_50%_at_16.8%_18.3%,white,rgb(184,148,255)_37.7%,rgb(24,0,66))] shadow-[-1.25rem_-1.25rem_3.125rem_rgb(255,255,255,.5),-1.25rem_-1.25rem_5rem_rgb(255,255,255,.1),0_0_3.125rem_rgb(140,69,255)]"></div>
      {/* FIRST CIRCLE */}
      <motion.div
        style={{
          translateY: "-50%",
        ...
        className="absolute h-[21.5rem] w-[21.5rem] md:h-[580px] md:w-[580px] border opacity-20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 "
      >
        {/* dots on 1st circle */}
